...
response = HTTParty.delete( "#{BASE_URL}/api2/group_loan_weekly_collection_voluntary_savings_entries/#{selected_voluntary_savings_id}" ,
  :query => {
    :auth_token => auth_token
  }
...
=begin
  ...
  DELETE "/api2/group_loan_weekly_collection_voluntary_savings_entries/79892?auth_token=4Q5CTZUUVFz1Fg9n1zqs"
  
  {"auth_token"=>"4Q5CTZUUVFz1Fg9n1zqs", "id"=>"79892"}
