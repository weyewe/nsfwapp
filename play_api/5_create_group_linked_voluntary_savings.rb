...
=begin
  ...
  POST "/api2/group_loan_weekly_collection_voluntary_savings_entries?auth_token=4Q5CTZUUVFz1Fg9n1zqs"

  {"group_loan_weekly_collection_voluntary_savings_entry"=>{"amount"=>"500000.0", "group_loan_membership_id"=>"15211", "group_loan_weekly_collection_id"=>"52314", "direction"=>"1"}, "auth_token"=>"4Q5CTZUUVFz1Fg9n1zqs"}
  
  response sent by the server IF SUCCESS

 {"success"=>true, "group_loan_weekly_collection_voluntary_savings_entries"=>[{"id"=>79892, "amount"=>"500000.0", "group_loan_membership_id"=>15211, "group_loan_weekly_collection_id"=>52314, "created_at"=>"2015-06-13T05:42:16.129Z", "updated_at"=>"2015-06-13T05:42:16.129Z", "direction"=>1}], "total"=>1} 
