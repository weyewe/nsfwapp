Ext.define('AM.view.operation.grouploanweeklycollection.UncollectForm', {
  extend: 'Ext.window.Window',
  alias : 'widget.uncollectgrouploanweeklycollectionform',

  title : 'Uncollect GroupLoanWeeklyCollection',
  layout: 'fit',
	width	: 400,
